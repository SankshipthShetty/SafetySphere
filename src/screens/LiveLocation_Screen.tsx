  ...
  import { Dimensions, StyleSheet, View,SafeAreaView,Text, TouchableOpacity,Linking,KeyboardAvoidingView, Platform} from 'react-native';
  ...
  if (camera){
    ...
    // const sendalert=()=>{
    //     SendSMS.send({
    //       body: 'Hi!... I am in danger. Please help me. My current location is: 12.867077, 74.925747. Please help me as soon as possible.',
    ...
    const sendalert = async () => {
      try {
        // Check if the currentLocation state is available
        if (currentLocation) {
          const latitude = currentLocation.latitude;
          const longitude = currentLocation.longitude;
          const body = `Hi, I am in danger. Please help me. My current location is: ${latitude}, ${longitude}. Please help me as soon as possible. Here is the Google Maps link for my location: https://www.google.com/maps?q=${latitude},${longitude}`;
  ...
  return (
    ...
    keyboardVerticalOffset={Platform.OS === 'android' ? 64 : 0} // Adjust this value based on your UI layout
  >
    <View style={styles.container}>
      ...
      <Text style={styles.buttonText}>Choose Origin and Destination</Text>
      
      {showText && <View style={styles.searchContainer}>
        <>
